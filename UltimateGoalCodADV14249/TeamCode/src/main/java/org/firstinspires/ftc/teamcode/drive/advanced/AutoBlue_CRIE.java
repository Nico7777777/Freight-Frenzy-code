...
//
//@Autonomous
//public class AutoBlue_CRIE extends LinearOpMode {
//
//    //drivetrain
...
//                .lineToLinearHeading(new Pose2d(63, 4, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory preparePark = drive.trajectoryBuilder(new Pose2d(63, 4, Math.toRadians(0)))
...
//                .build();
//
//        Trajectory preparePark1 = drive.trajectoryBuilder(new Pose2d(45, 0, Math.toRadians(0)))
...
//                .build();
//
//        Trajectory park = drive.trajectoryBuilder(new Pose2d(40, -20, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(74, -20, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//
//        Trajectory dropWobble = drive.trajectoryBuilder(new Pose2d(61, 0, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(82, -17, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory prepareCollectRing = drive.trajectoryBuilder(new Pose2d(82, -17, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(77, -17, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory collectRing = drive.trajectoryBuilder(new Pose2d(77, -17, Math.toRadians(180)))
...
//                .build();
//
//        Trajectory park = drive.trajectoryBuilder(new Pose2d(52, -17, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(74, -17, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//
//        Trajectory dropWobble = drive.trajectoryBuilder(new Pose2d(61, 0, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(104, 5, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory prepareForRing = drive.trajectoryBuilder(new Pose2d(104, 5, Math.toRadians(0)))
...
//
//
//        Trajectory prepareForRing1 = drive.trajectoryBuilder(new Pose2d(28,0, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(17,-12, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
...
//
//
//        Trajectory shootRing  = drive.trajectoryBuilder(new Pose2d(17,-12, Math.toRadians(-9)))
//                .lineToLinearHeading(new Pose2d(30.2,-12, Math.toRadians(-9)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(100 ,DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory getLastRing = drive.trajectoryBuilder(new Pose2d(30.2,-13, Math.toRadians(-8)))
//                .lineToLinearHeading(new Pose2d(60.4,-13, Math.toRadians(-8)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
...
//                .build();
//
//        Trajectory park = drive.trajectoryBuilder(new Pose2d(60.4,-13, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(80,-13, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(100 ,DriveConstants.TRACK_WIDTH)
