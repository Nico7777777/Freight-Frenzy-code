...
//                .splineTo(new Vector2d(58, 0), Math.toRadians(8.5),
...
//                })
//
//                .splineTo(new Vector2d(64, 0), Math.toRadians(8.5),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
...
//                )
//
//                .splineTo(new Vector2d(100, -4), Math.toRadians(0),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//                        ), new ProfileAccelerationConstraint(40)
//                )
//                .splineTo(new Vector2d(61, 0), Math.toRadians(180  ),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//                .lineToLinearHeading(new Pose2d(86, 17, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory prepareCollectRing = drive.trajectoryBuilder(new Pose2d(86, 17, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(80, 17, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory collectRing = drive.trajectoryBuilder(new Pose2d(80, 17, Math.toRadians(178)))
//                .lineToLinearHeading(new Pose2d(52, 17, Math.toRadians(178)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//                .lineToLinearHeading(new Pose2d(17,22, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
...
//
//
//        Trajectory shootRing  = drive.trajectoryBuilder(new Pose2d(17,22, Math.toRadians(-12)))
//                .lineToLinearHeading(new Pose2d(32.4,22, Math.toRadians(-12)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(100 ,DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory getLastRing = drive.trajectoryBuilder(new Pose2d(32.4,22, Math.toRadians(-10)))
//                .lineToLinearHeading(new Pose2d(60.8,22, Math.toRadians(-10)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
...
//                .build();
//
//        Trajectory park = drive.trajectoryBuilder(new Pose2d(60.8,22, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(80,22, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(100 ,DriveConstants.TRACK_WIDTH)
