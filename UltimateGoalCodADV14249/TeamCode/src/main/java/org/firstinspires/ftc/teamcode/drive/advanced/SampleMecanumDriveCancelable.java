...
public class SampleMecanumDriveCancelable extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(5.3, 0.05,0.38);//(5.3, 0.05, 0.38);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(2.1, 0.09, 0.32);//(2.1, 0.09, 0.32);
