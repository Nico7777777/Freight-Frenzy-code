...
//
//@Autonomous
//public class AutoBlue_CRII extends LinearOpMode {
//
//    //drivetrain
...
//                .lineToLinearHeading(new Pose2d(66, 45, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory preparePark = drive.trajectoryBuilder(new Pose2d(66, 45, Math.toRadians(0)))
...
//                .lineToLinearHeading(new Pose2d(80, 25, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//
//        Trajectory dropWobble = drive.trajectoryBuilder(new Pose2d(61, 0, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(110, 38, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60, DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory prepareForRing = drive.trajectoryBuilder(new Pose2d(110, 38, Math.toRadians(0)))
...
//                .build();
//
//        Trajectory prepareForRing1 = drive.trajectoryBuilder(new Pose2d(65,0, Math.toRadians(0)))
...
//
//
//        Trajectory prepareForRing2 = drive.trajectoryBuilder(new Pose2d(23,0, Math.toRadians(0)))
...
//
//
//        Trajectory shootRing  = drive.trajectoryBuilder(new Pose2d(20,18, Math.toRadians(-8)))
//                .lineToLinearHeading(new Pose2d(34,18, Math.toRadians(-8)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
...
//
//
//        Trajectory getLastRing = drive.trajectoryBuilder(new Pose2d(35,18, Math.toRadians(-7)))
//                .lineToLinearHeading(new Pose2d(60.8,18, Math.toRadians(-7)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
...
//                .build();
//
//        Trajectory park = drive.trajectoryBuilder(new Pose2d(60.8,18, Math.toRadians(0)))
//                .lineToLinearHeading(new Pose2d(74,18, Math.toRadians(0)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(60 ,DriveConstants.TRACK_WIDTH)
